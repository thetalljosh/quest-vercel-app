CREATE TYPE "public"."guild_request_status" AS ENUM('pending', 'approved', 'rejected');--> statement-breakpoint
CREATE TYPE "public"."guild_role" AS ENUM('creator', 'admin', 'member');--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "quests" ADD COLUMN "guild_id" uuid;--> statement-breakpoint
...
ALTER TABLE "guild_join_requests" ADD CONSTRAINT "guild_join_requests_requester_id_users_id_fk" FOREIGN KEY ("requester_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "guild_join_requests" ADD CONSTRAINT "guild_join_requests_reviewed_by_id_users_id_fk" FOREIGN KEY ("reviewed_by_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "guilds" ADD CONSTRAINT "guilds_creator_id_users_id_fk" FOREIGN KEY ("creator_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
